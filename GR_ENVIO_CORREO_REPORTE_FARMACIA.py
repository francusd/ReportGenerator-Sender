...
df_onda_centro=pd.read_excel('C:\DevProjects\DATASETS\REPORTE_GERENCIAL_VENTAS_FARMACIA_CENTRO.xlsx')
...
color:#004080;">REPORTE GERENCIAL DIARIO DE VENTAS FARMACIA: CENTROS & DEPARTAMENTO</h5>
<p style="font-family:Arial; font-size:10px;">
Buen día a todos,<br>
Ventas Diarias FARMACIA <strong>CENTRO & DEPARTAMENTO</strong> acumuladas al corte: 
<strong>{formatted_yesterday}</strong><br><br>
</p>
"""

# Create both tables
html_centro = build_html_table(df_onda_centro, "Ventas FARMACIA - CENTROS")
html_depa = build_html_table(df_onda_depa, "Ventas FARMACIA - DEPARTAMENTO")
