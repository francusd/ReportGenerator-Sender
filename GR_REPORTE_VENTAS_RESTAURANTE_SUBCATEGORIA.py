...
#
result2= result2[['SECCION','VENTA AYER' ,'VENTA ACT','VENTA HIST','CRECIMIENTO','CRECIMIENTO %']]
...
#total_row['MARGEN %']=((total_row['VENTA ACT'].round(2)-total_row['COSTO ACT'].round(2))/total_row['VENTA ACT'].round(2))*100
...
df_total.to_excel('C:\DevProjects\DATASETS\REPORTE_GERENCIAL_VENTAS_RESTAURANTE_SUBCATEGORIA.xlsx',index=False)