...
color:#004080;">REPORTE GERENCIAL DIARIO DE VENTAS YYYY</h5>
...
html_comprador=build_html_table(df_onda_comprador, "Ventas YYYY - COMPRADORES")
...
msg['Subject'] = "📈 REPORTE GERENCIAL DIARIO DE VENTAS YYYY"
