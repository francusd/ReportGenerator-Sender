...
df_onda_comprador=pd.read_excel('C:\DevProjects\DATASETS\LA_ONDA_COMPRADOR_VENTAS.xlsx')
...
color:#004080;">REPORTE GERENCIAL DIARIO DE VENTAS LA ONDA</h5>
<p style="font-family:Arial; font-size:10px;">
Buen día a todos,<br>
Ventas Diarias La ONDA <strong>CENTRO, CATEGORIA, y COMPRADORES</strong> acumuladas al corte: 
...
html_comprador=build_html_table(df_onda_comprador, "Ventas LA ONDA - COMPRADORES")

# Combine everything
html_full = html_intro + html_centro + html_depa + html_comprador
...
msg['Subject'] = "📈 REPORTE GERENCIAL DIARIO DE VENTAS LA ONDA"
msg['From'] = "alertabi@elfuerte.com.pa"
recipients = ["abraham@gruporaphael.com", "andres.paredes@gruporaphael.com","diego.thau@gruporaphael.com", "luis.pacheco@gruporaphael.com", "horacio.perigault@gruporaphael.com","melissa.madrid@gruporaphael.com","mario.smith@gruporaphael.com","carlo.smith@gruporaphael.com","elvis.elias@gruporaphael.com","omer.avital@gruporaphael.com","bryan.neiman@gruporaphael.com","ehud.bottaro@gruporaphael.com","gabriel.homsany@gruporaphael.com","isaac.zebede@gruporaphael.com","roberto.benaim@gruporaphael.com","daddhiatt.irimia@gruporaphael.com","rodolfo.watson@gruporaphael.com","rrenteria@gruporaphael.com","juan.arosemena@gruporaphael.com","rafi@gruporaphael.com","pindaro.brandao@gruporaphael.com","leyda.quiel@gruporaphael.com","francisco.tudisco@gruporaphael.com","mariangel.centella@gruporaphael.com"]
#"francisco.tudisco@gruporaphael.com"]
